                ...
                <div class="content-menu">
                    <div class="nav-menu">
                        ...
                        <nav id="main-menu" class="main-menu">
                            <ul class="menu">
                                @if(in_array('1',$array))
                                    <li><a href="#qui_sommes_nous">{{\App\Models\Menusite::libelleMenu(1)['titre_menu']}}</a></li>
                                @endif
                                @if(in_array('2',$array))
                                    <li><a href="#services">{{\App\Models\Menusite::libelleMenu(2)['titre_menu']}}</a></li>
                                @endif
                                @if(in_array('3',$array))
                                    <li><a href="#realisation">{{\App\Models\Menusite::libelleMenu(3)['titre_menu']}}</a></li>
                                @endif
                                @if(in_array('4',$array))
                                    <li><a href="#contact">{{\App\Models\Menusite::libelleMenu(4)['titre_menu']}}</a></li>
                                @endif
                            </ul>
                        </nav>
                    </div>
