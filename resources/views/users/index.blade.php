                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        ...
                        @if(in_array('add_user',session('InfosAction')))
                            <a class="btn btn-primary btn-label right" href="{{route('users.create')}}"><i class="ri-add-line label-icon align-middle fs-16 ms-2"></i>Ajouter</a>
                        @endif
...
@section('JS_content')
    ...
    <script type="text/javascript">
        ...
        function funcRecher(){
            ...
            return $.ajax({
                url: '{{ url("/users/")}}',data: filtreData,type: 'GET',
        ...
        $(document).on('click', '.btn-delete', function () {
			id = $(this).data("id");
			$.ajax({url : '{{ url("users/AffichePopDelete/") }}/'+id,type : 'GET',dataType : 'html',
