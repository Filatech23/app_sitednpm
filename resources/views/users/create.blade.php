        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <strong><div class="msgAjouter"></div></strong>
                    <form action="{{route('users.store')}}" method="post" id="form" class="row g-3 needs-validation" novalidate>
                        @csrf()
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    {!! Form::text('name','',["id"=>"name","class"=>"form-control","required"=>"required",'placeholder'=>"Entrer votre nom",'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="prenom" class="form-label">{{trans('data.prenom')}}<strong style='color: red;'> *</strong></label>
                                    {!! Form::text('prenom','',["id"=>"prenom","class"=>"form-control","required"=>"required",'placeholder'=>"Entrer votre prénom",'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="tel_user" class="form-label">{{trans('data.tel_user')}}<strong style='color: red;'> *</strong></label>
                                    {!! Form::text('tel_user','',["id"=>"tel_user","class"=>"form-control","required"=>"required",'placeholder'=>"Entrer votre téléphone",'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
						            ...
						            {!! Form::select('id_role',$sltRole ,null,["id"=>"id_role","class"=>"form-select select2",'required'=>'required']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
						            ...
						            {!! Form::select('is_active',$addUse ,null,["id"=>"is_active","class"=>"form-select select2",'required'=>'required']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="other_infos_user" class="form-label">{{trans('data.other_infos_user')}}</label>
                                    {!! Form::text('other_infos_user','',["id"=>"other_infos_user","class"=>"form-control",'placeholder'=>"Entrer votre d'autre informations",'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="text-end">
                                    <a href="{{route('users.index')}}" class="btn btn-outline-dark waves-effect mr-10">Fermer</a>
