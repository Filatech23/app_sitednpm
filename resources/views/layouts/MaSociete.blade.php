                ...
                <div class="live-preview">
                    {!! Form::open(array('class' => 'kt-form','url' => 'mysociety/updatepage','method' => 'POST','enctype' => 'multipart/form-data','id' => 'formProfil','novalidate'=>'novalidate')) !!}
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-12">
                                <div class="form-floating">
                                    <textarea class="form-control"  id="otherfloatingInput" placeholder="Autres information" name="pied_soc" rows="5">{{$societe->pied_page_soc}}</textarea>
                                    <label for="otherfloatingInput">Autre infos.</label>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-floating">
                                    <textarea class="form-control"  id="localisationInput" placeholder="Localisation" name="localisation" rows="5">{{$societe->localisation}}</textarea>
                                    <label for="localisationInput">Localisation</label>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="text-center">
