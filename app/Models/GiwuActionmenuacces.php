...
class GiwuActionmenuacces extends Model {
	...
	protected $table = 'dnpmsiteg_action_menu_acces';
    ...
    public static function getActionParRole($id_role){
		...
		return self::join('dnpmsiteg_action_acces','dnpmsiteg_action_acces.id_action','dnpmsiteg_action_menu_acces.action_id')
