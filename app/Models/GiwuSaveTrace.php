...
{
    protected $table = 'dnpmsiteg_save_trace';
    ...
    public static function getListeUSerSaveTrace(){
        ...
        return self::join('dnpmsiteg_users','dnpmsiteg_users.id','dnpmsiteg_save_trace.id_user')
                            ->select(DB::raw("CONCAT(name,' ',prenom) AS nomprenom"),'dnpmsiteg_users.id')
